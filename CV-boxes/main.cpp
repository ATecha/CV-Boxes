/*
Box Counting: main.cpp (1 of 1 program files)
Authors: Aaron Holloway, Andrew Wietecha
12/5/2018

Goal: count the boxes on a pallet given an angled photo of the boxes on a pallet.
Achieved: After much refinement and attempts with multiple approaches, edges/lines and contours.
*/
...
// PRE:  none
// POST: displays image in its own GUI window, and saves it to disk with the given filename.
/////////////////////////////////////////////////////////////////////////////////
...
// PRE: input image is in BGR colorspace
// POST: image returned is in greyscale colorspace
/////////////////////////////////////////////////////////////////////////////////
...
// PRE: input image is not empty.
// POST: returned image is blurred either according to default values, or values specified in method call.
/////////////////////////////////////////////////////////////////////////////////
...
// PRE: image is not empty
// POST: image has median blur applied with given values, or default values if not specified.
/////////////////////////////////////////////////////////////////////////////////
...
// BorderType - Pixel extrapolation method. Default 4. Probably don't need to change this.
// PRE: image is not empty
// POST: image has bilateral blur applied with given values, or default values if not specified.
/////////////////////////////////////////////////////////////////////////////////
...
// Value - Saturation intensity. Positive value increases saturation, negative decreases saturation.
// PRE: image is not empty, image is greyscale
// POST: image saturation is adjusted by the given value, or the default value if no value is specified
/////////////////////////////////////////////////////////////////////////////////
...
// Parameters:
// Value - Contrast intensity. Changes by a scalar: < 1 decreases contrast, > 1 increases contrast, 1 is no change.
// PRE: image is not empty, image is greyscale
// POST: image contast is adjusted by the given value, or the default value if no value is specified
/////////////////////////////////////////////////////////////////////////////////
...
// PRE: image is not empty, is greyscale, and ideally has been processed for noise reduction
// POST: image contains lines from Canny edge detection, with the the given values, or the default values if no values are specified
/////////////////////////////////////////////////////////////////////////////////
...
// PRE: image is not empty, and is greyscale
// POST: reduces number of greys, by coloring greys under given threshold black
...
// PRE: image is not empty, is greyscale, and ideally has been processed for noise reduction
// POST: image contains lines from LaPlacian edge detection, with the the given value, or the default value if no value is specified
/////////////////////////////////////////////////////////////////////////////////
...
// PRE: line detection has been run on the image
// POST: lines are overlaid on image according to Hough transform, using given values, or default values of no values are specified.
//		Line pruning is also performed, however this only reduces the number of similar lines.
//		It does not gaurantee the remaining lines are the best lines.
//		Pre-pruned lines are in red, remaining lines are in green.
// portions of this method are adapted from:
...
Mat hough(Mat& image, double rho = 1.0, double theta = 3, int threshold = 150) {
	...
	//this block almost entirely from source credited in header.
	...
	//finally, draw the remaining lines in green
	for (int i = 0; i < lineSegs.size(); i++) {
...
// (not currently used)
// PRE: after line detection, lines are close but not joined
// POST: merges and smoothes lines or contours
/////////////////////////////////////////////////////////////////////////////////
Mat morph(Mat& image) {
	Mat result = image.clone();
...
// PRE: image has had lines or contours detected
// POST: makes edges/contours more apparent via widening and smoothing
/////////////////////////////////////////////////////////////////////////////////
...
// PRE: image has had line detection run
// POST: image contains contours
/////////////////////////////////////////////////////////////////////////////////
...
// PRE: image is not empty, and is greyscale
// POST: corners are detected using Harris corner detection and highlighted in image.
/////////////////////////////////////////////////////////////////////////////////
...
// Used to pre-process image to ultimately reduce noise and improve edge, line, and contour detection results.
// PRE: image is not empty
// POST: image converted to greyscale, with saturation, contrast, and blur adjustments.
/////////////////////////////////////////////////////////////////////////////////
...
// PRE: jpg image(s) in same directory as this program
//		IMAGE PRE: image is of a pallet angled such that a corner is pointed toward the photographer,
//		Only the top layer can be a partial layer
//		Partial layers have items removed so that remaining items are the furthest from photographer
// POST: (currently) outputs image with features detected building up to counting the boxes in the image.
/////////////////////////////////////////////////////////////////////////////////
